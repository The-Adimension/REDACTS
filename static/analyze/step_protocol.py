...
investigation stage implements, the :class:`StepResult` return type,
...
class InvestigationStep(Protocol):
    ...
    def execute(self, context: InvestigationContext) -> StepResult:
        ...
        raise RuntimeError("InvestigationStep.execute must be implemented by subclasses")
...
def sha256(path: Path) -> str:
    ...
    Delegates to :func:`core.hashing.compute_single_hash`. Returns
    ``""`` on any error.
    """
