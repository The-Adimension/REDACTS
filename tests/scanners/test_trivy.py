...
from static.scanners.external import ExternalToolResult
from static.scanners.phase_protocol import OrchestratorContext
from static.scanners.phases import TrivyPhase
...
def test_trivy_phase_success(
    ...
    monkeypatch.setattr(
        "static.scanners.trivy_adapter.TrivyAdapter", lambda: adapter
    )
...
def test_trivy_phase_exception(
    ...
    monkeypatch.setattr(
        "static.scanners.trivy_adapter.TrivyAdapter", RaisingAdapter
    )
